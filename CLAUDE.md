...
- Read the relevant instruction file before building anything. When its wording is ambiguous, match
  the worked examples under `Documentation/Examples/`, which pass every gate.
...
- `Templates/` is scaffolding and stays out of coverage. `Documentation/Examples/Test-QualityGates.ps1`
